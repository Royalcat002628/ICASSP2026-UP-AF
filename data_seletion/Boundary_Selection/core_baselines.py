...
if __name__ == '__main__':
    ...
    parser.add_argument('--feature_path', default='../subsets/Ucity/Ucity_train.npy', type=str, help='path of saved features')
    parser.add_argument('--output_dir', default='../subsets/Ucity/core_baselines', type=str, help='dir to save the visualization')
